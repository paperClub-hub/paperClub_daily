...
seq_lst = [['GGT', 'GGC', 'GGA', 'GGG'], ['AAA', 'AAG'], ['GCT', 'GCC', 'GCA', 'GCG'], ['TTA', 'TTG', 'CTT', 'CTC', 'CTA', 'CTG'], ['ATT', 'ATC', 'ATA'], ['ACT', 'ACC', 'ACA', 'ACG'], ['GGT', 'GGC', 'GGA', 'GGG'], ['GAC'], ['TAA', 'TAG', 'TGA'], ['GAT', 'GAC'], ['TAC'], ['GTT', 'GTC', 'GTA', 'GTG'], ['TTT', 'TTC'], ['TTA', 'TTG', 'CTT', 'CTC', 'CTA', 'CTG'], ['GGT', 'GGC', 'GGA', 'GGG'], ['AAT', 'AAC'], ['TGG'], ['AAT'], ['AAC'], ['CCA'], ['TAC'], ['CAG']]
seq_lst = seq_lst[: 4]
